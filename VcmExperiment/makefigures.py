...
paper_figures = [
    ...
    make_figure("Results/HomeOffice",
        ...
        "\\textsc{Home Office} (a.k.a. The New Normal)", exposure=1, show_method_names=False,
...
width_cm = 17.7
figuregen.figure(paper_figures, width_cm, "Results/VcmFigure.pdf",
    tex_packages=["{dfadobe}", "{color}", "{contour}", "{pdfrender}", "{xcolor}"])
# figuregen.figure(additional_figures, width_cm, "Results/VcmOther.pdf",
#     tex_packages=["{dfadobe}", "{color}", "{contour}"])
